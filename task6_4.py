...
#for i in range (10):
    #print("vysledne Y", Y[i])
print("rozptyl", s.dispersion(Y))
...
#s = Shoot(np.array([0, 0]), np.array([10, 0]), 48,np.array([-100,200,-300,400]),10,np.array([0,-1]),1000)
